            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Application</strong> refers to KIM Bermasa, the software program provided by the
                                Company.</p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Diskominfotik, Kabupaten
                                Bengkalis.</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a
                                href="https://diskominfotik.bengkaliskab.go.id/web/link/kontak"
                                rel="external nofollow noopener"
                                target="_blank">https://diskominfotik.bengkaliskab.go.id/web/link/kontak</a></li>
                    </ul>
                </div>
            </div>
        </div>
