		...
		<table id="datatable" class="table table-striped table-bordered display" style="width:100%">
			<thead class="bg-primary">
				<tr>
					...
					<th class="text-center">Rincian_informasi</th>
					<th class="text-center">Tujuan_penggunaan</th>
					<th class="text-center">Opd</th>
					<th class="text-center">Cara_memperoleh</th>
					<th class="text-center">Salinan_informasi</th>
					<th class="text-center">Cara_mendapatkan</th>
