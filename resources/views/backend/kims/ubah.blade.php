...
<div class="row">
    <div class="col-md-12">
		...
		<p>
			...
			{!! Form::select('kecamatan_id',$kecamatan_id, $data->wilayah->parent_id, array('id' => 'kecamatan_id', 'class' => 'form-control select2', 'placeholder'=>'Pilih','style' => 'width:100%')) !!}
		</p>
		<p>
			{!! Form::label('kelurahan_id', 'Pilih Kelurahan', ['class'=>'control-label']) !!}
			{!! Form::select('kelurahan_id',$kelurahan_id, $data->wilayah_id, array('id' => 'kelurahan_id', 'class' => 'form-control select2', 'placeholder'=>'Pilih','style' => 'width:100%')) !!}
		</p>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        // On page load, trigger change event for kecamatan dropdown to pre-select kelurahan
        ...
        $('#kecamatan_id').on('change', function(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    // If kelurahan_id is already selected, maintain its selection
                    var selected_kelurahan_id = $('#kelurahan_id').data('selected');
                    if(selected_kelurahan_id){
                        $('#kelurahan_id').val(selected_kelurahan_id);
                    }
                },
